...
class VecTaskPython(VecTask):
    ...
    # send actions to task env, make step: pre_physics_step, post_physics_step
    def step(self, actions, id=0):
        actions_tensor = torch.clamp(actions, -self.clip_actions, self.clip_actions)

        self.task.step(actions_tensor, id)
        
        # return obs_buf, rew_buf, reset_buf, extra infos
    ...
    def set_goal_position(self, goal_positions):
        ...
        """
        self.task.set_goal_displacement(goal_displacement)
