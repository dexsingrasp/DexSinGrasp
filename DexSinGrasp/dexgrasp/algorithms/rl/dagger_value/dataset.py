...
class ObjectTrajectoryDatasetBatch(Dataset):
    ...
    def _load_object_trajectory(self, nobj, ntraj):
        ...
        object_trajectory_data_path = osp.join(self.trajectory_dir, '{:04d}_seed0_student'.format(self.target_object_lines[nobj]), 'trajectory/trajectory_{:03d}.pkl'.format(ntraj))
        ...
        if self.vision_based:
            ...
            object_state_path = osp.join(self.trajectory_dir, '{:04d}_seed0_student'.format(self.target_object_lines[nobj]), 'pointcloud/pointcloud_{:03d}.pkl'.format(ntraj))
