...
#     'height': 0.15,  # center height
#     'eye': np.array(
#         [[ 0.3, 0.0, 0.3 ],  # monitor view (not saved in pointcloud) 
#         [-0.34, -0.04, 0.18], # left view
#          [0.34, 0.03, 0.21] # right view
#          ]),  

#     'lookat': np.array([
#         [ 0.0, 0.0, 0.2 ],  # monitor view (not saved in pointcloud)  
#         [0.20, 0.01, 0],  # left view
#         [-0.38, -0.04, 0],  # right view
#         ])
# }

# for rendering high-quality pc in paper
# vision-based cameras
# CAMERA_PARAMS = {
#     'num': 10,
#     'dist': 0.3, # center distance
...
def depth_RGB_image_to_point_cloud_GPU_batch(
